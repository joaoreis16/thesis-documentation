...
\TitlePT{UM SISTEMA CONVERSACIONAL DE PESQUISA SOBRE BASE DE DADOS MÉDICAS}
...
\Acknowledgements{Em primeiro lugar, expresso minha profunda gratidão aos meus orientadores, especialmente ao Professor Auxiliar João Rafael Almeida. O seu apoio foi além da orientação do projeto; ele guiou-me e desafiou-me ao longo de todo este processo, instigando-me a superar e enfrentar novos desafios. Agradeço também ao meu colaborador, Tiago Almeida, que sempre esteve disponível para me aconselhar e guiar no melhor caminho.

A todos os meus amigos, estou imensamente grato pelo constante companheirismo e pela partilha da vida académica ao longo dos últimos anos. À Inês, um agradecimento especial pela paciência e pelo suporte emocional incondicional.

Por fim, dedico este trabalho à minha família, a grande base da minha pessoa, que sempre me apoiou e tornou possível a minha jornada até aqui.
}
...
\IA{I acknowledge the use of ChatGPT-3.5 (Open AI, https://chat.openai.com) to help structuring the document and to debug certain issues during the development phase. I also acknowledge the use of Grammarly (Grammarly, https://www.grammarly.com/) premium version to help maintain a formal tone in my writing and improve my grammatical structure, punctuation and vocabulary.}
