...
\TitlePT{UM CONSTRUTOR DE PESQUISA CONVERSACIONAL EM BASE DE DADOS CLÍNICAS MÉDICAS}
...
\TitleEN{A CONVERSATIONAL QUERY BUILDER ON MEDICAL CLINICAL DATABASES}
...
\SecondSupervisor{João Rafael Almeida}{associado}{do Departamento de Electrónica, Telecomunicações e Informática}{da Universidade de Aveiro}
