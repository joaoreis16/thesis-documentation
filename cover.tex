...
\Supervisor{João Rafael Almeida}{associado}
...
\SecondSupervisor{José Luís Oliveira (co-orientador)}{catedrático}{do Departamento de Electrónica, Telecomunicações e Informática}{da Universidade de Aveiro}
...
%% add the other members of the jury later here
