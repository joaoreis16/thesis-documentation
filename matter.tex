...
\usepackage[style=USenglish]{csquotes}
...
\usepackage[backend=biber, style=ieee-modified, sorting=none, natbib=true, mincitenames=1, maxcitenames=2, maxbibnames=10, minbibnames=5]{biblatex}
