...
% é preciso haver um controlo do que já foi respondido e do que falta responder.
% para isso, os 2 ficheiros foram criados
% e existe um pointer que aponta para a parte do template que falta responder. o pointer segue sequencialmente as keys do ficheiro das questões.
...
\section{Integration with OHDSI ATLAS}
