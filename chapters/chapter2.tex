...
The Mistral\cite{jiang_mistral_2023} was introduced by Mistral AI. It is an open source {\llm} with 7 billion of parameters. This model has 8 192 context length and fine-tuned on 128K tokens. Mistral 7B originated two other models: Mixtral 8x7B~\cite{jiang_mixtral_2024} and Mixtral 8x22B. The table~\ref{table:comparison} summarizes the important aspects of comparison between this foundation {\llm}.
