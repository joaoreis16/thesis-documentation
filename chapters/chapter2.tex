...
% https://arxiv.org/pdf/2110.01529.pdf dá para referir este artigo ?
...
In this section, I defined a {\llm}, explored briefly their architecture, compared between foundation {\llm}, and finally, addressed some of its limitations.
...
\begin{table}[ht]
    ...
    \caption{Comparison of foundation {\llm}.}
...
In this section, I explored the implementation of chatbots, their components, and existing tools. %% ALTERAR ESTA PARTE !!! 
...
% REMOVER CITAÇÃO ==> borah_survey_2019 
...
% explicar o porquê da escolha de métodos tradicionais (bm25) agora?
