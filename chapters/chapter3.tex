...
\begin{table}[H]
  ...
  \multirow{3}{*}{{\nlu}}    & Analyze topic                   & \begin{tabular}[c]{@{}l@{}}Identify if the user message is related to health. \\ If so, identify the research topic in the field of health.\end{tabular} \\ \cline{2-3} 
                              & Analyze yes or no answer        & Identify if the answer is positive or negative for a respective question.                                                                                \\ \cline{2-3} 
                              & Analyze answer to question      & Identify if the answer is a response for a respective question.                                                                                          \\ \hline
  \end{tabular}%
  }
